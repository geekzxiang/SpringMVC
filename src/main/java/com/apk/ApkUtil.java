...
//			System.out.println(source);
    ...
    public static void main(String[] args) {
        try {
            String demo = "/Users/ZhouXiang/Android/app/build/outputs/apk/app-debug.apk";
            if (args.length > 0) {
                demo = args[0];
            }
            ...
            IconUtil.extractFileFromApk(demo, apkInfo.getApplicationIcon(), "/Users/ZhouXiang/Android/app/build/outputs/apk/icon.png");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
